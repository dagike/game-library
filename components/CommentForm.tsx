...
export function CommentForm({
  ...
  return (
    <form action={addComment} className="flex flex-col gap-3">
      ...
      <button
        type="submit"
        className="w-fit rounded bg-primary-600 px-4 py-2 text-sm text-white transition-colors hover:bg-primary-700 dark:bg-primary-400 dark:text-gray-950 dark:hover:bg-primary-300"
      >
        Post comment
      </button>
    </form>
