    ...
    <div className="flex flex-col gap-4">
      <form onSubmit={handleSearch} className="flex gap-2">
        ...
        <button
          type="submit"
          disabled={loading}
          className="rounded bg-primary-600 px-4 py-2 text-white transition hover:bg-primary-700 active:scale-95 disabled:opacity-50 dark:bg-primary-400 dark:text-gray-950 dark:hover:bg-primary-300"
        >
        ...
        {results.map((result) => (
          ...
          >
            ...
            <form action={addGame}>
              ...
              <button
                type="submit"
                className="rounded border border-primary-300 px-3 py-1.5 text-sm text-primary-700 transition-colors hover:bg-primary-50 dark:border-primary-700 dark:text-primary-400 dark:hover:bg-primary-900"
              >
                Add
              </button>
            </form>
